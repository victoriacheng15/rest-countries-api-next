function Form({
	...
	return (
		<form className="flex flex-col justify-between gap-8 py-8 md:flex-row">
			...
			<button type="button" onClick={onClick} className="p-2 text-lg capitalize border-2 border-gray-900  w-36 rounded-xl dark:border-slate-100 dark:text-slate-100">Clear search</button>
		</form>
	);
}
